  ...
  protected static int computeDimension(ResultPoint topLeft,
    ...
    switch (dimension & 0x03) { // mod 4
      ...
      case 2:
        ...
        break;
      case 3:
        //System.err.println("dimension is 3 mod 4");
        //throw NotFoundException.getNotFoundInstance();
    }
    return dimension;
  }
  ...
  private  float sizeOfBlackWhiteBlackRun(int fromX, int fromY, int toX, int toY) {
    ...
    for (int x = fromX, y = fromY; x != toX; x += xstep) {
      ...
      if (state == 3) { // Found black, white, black, and stumbled back onto white; done
         int diffX = x - fromX;	// approx: 85: MOVE_I R21, T66	// approx: 84: SUB_I T66, R50, R1
         int diffY = y - fromY;	// approx: 87: MOVE_I R22, T67	// approx: 86: SUB_I T67, R49, R2
        return ( float) Math.sqrt(( double) (diffX * diffX + diffY * diffY));	// approx: 89: MUL_I T69, R22, R22	// approx: 90: ADD_I T70, T68, T69	// approx: 88: MUL_I T68, R21, R21
      }
      error += dy;
      if (error > 0) {
        if (y == toY) {
     ...
     int diffX = toX - fromX;	// approx: 74: MOVE_I R85, T84	// approx: 73: SUB_I T84, R3, R1
     int diffY = toY - fromY;	// approx: 76: MOVE_I R87, T86	// approx: 75: SUB_I T86, R4, R2
    return ( float) Math.sqrt(( double) (diffX * diffX + diffY * diffY));	// approx: 79: ADD_I T90, T88, T89	// approx: 77: MUL_I T88, R85, R85	// approx: 78: MUL_I T89, R87, R87
  }
