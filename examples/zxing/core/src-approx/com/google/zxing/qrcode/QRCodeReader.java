...
public class QRCodeReader implements Reader {
  ...
  public Result decode(BinaryBitmap image, Hashtable hints)
    ...
    if (hints != null && hints.containsKey(DecodeHintType.PURE_BARCODE)) {
      ...
      precise_all_FIELD1_TAG2(bits.bits);
      points = NO_POINTS;
    } else {
      ...
      precise_all_FIELD2_TAG3(points[0]);
      precise_all_FIELD3_TAG3(points[0]);
      precise_all_FIELD1_TAG2(bitMatrix.bits);
    }
  ...
  public static ResultPoint precise_all(ResultPoint x) {return x;}
  public static void accept_all_FIELD1_TAG2(int[] i){}
  public static void precise_all_FIELD1_TAG2(int[] i){}
  public static void accept_all_FIELD2_TAG3(ResultPoint p){}
  public static void accept_all_FIELD3_TAG3(ResultPoint p){}
  public static void precise_all_FIELD2_TAG3(ResultPoint p){}
  public static void precise_all_FIELD3_TAG3(ResultPoint p){}
  ...
  public static BitMatrix extractPureBits(BitMatrix image) throws NotFoundException {
    ...
    if (leftTopBlack == null) {
        System.err.println("no top left");
    ...
    if (x == minDimension || y == minDimension) {
        System.err.println("min dimension");
      throw NotFoundException.getNotFoundInstance();
    }
    ...
    if (rowEndOfSymbol <= x) {
        System.err.println("symbol ends too early");
      throw NotFoundException.getNotFoundInstance();
    }
    rowEndOfSymbol++;
    ...
    if ((rowEndOfSymbol - x) % moduleSize != 0) {
        System.err.println("unaligned size");
      throw NotFoundException.getNotFoundInstance();
    }
    ...
    if ((x + (dimension - 1) * moduleSize) >= width ||
        ...
        System.err.println("module too wide");
      throw NotFoundException.getNotFoundInstance();
    }
