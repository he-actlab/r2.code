...
public final class BitArray {
  ...
  	// approx: 3: GETFIELD_I T3, R0, .size
  public String toString() {	// approx: 22: ADD_I R21, R11, IConst: 1	// approx: 7: GETFIELD_I T12, R0, .size	// approx: 6: MOVE_I R10, IConst: 0
    StringBuffer result = new StringBuffer(size);	// approx: 11: AND_I T8, R11, IConst: 7
    for (int i = 0; i < size; i++) {	// approx: 14: MOVE_I T13, IConst: 32
      if ((i & 0x07) == 0) {
        result.append(' ');	// approx: 19: MOVE_I T17, IConst: 88	// approx: 18: MOVE_I T18, IConst: 46
      }
