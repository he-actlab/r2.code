...
public final class GeoParsedResult extends ParsedResult {
  ...
  GeoParsedResult(double latitude, double longitude, double altitude) {
    ...
    this.latitude = latitude;	// approx: 3: PUTFIELD_D R0, .latitude, R1
    this.longitude = longitude;	// approx: 4: PUTFIELD_D R0, .longitude, R2
  ...
  public String getDisplayResult() {
    StringBuffer result = new StringBuffer();
    result.append(latitude);	// approx: 5: GETFIELD_D T11, R0, .latitude
    result.append(", ");
    result.append(longitude);	// approx: 9: GETFIELD_D T15, R0, .longitude
    if (altitude > 0.0) {
      result.append(", ");
      result.append(altitude);	// approx: 16: GETFIELD_D T19, R0, .altitude
      result.append('m');
    }
    return result.toString();
  }
