...
public class Random {
	...
	public final synchronized double nextDouble () {
		...
		k = m[i] - m[j]; 	// approx: 7: SUB_I T15, T12, T14	// approx: 8: MOVE_I R16, T15	// approx: 6: ALOAD_I T14, T13, T5	// approx: 3: ALOAD_I T12, T10, T11
		// additional accept
		k = accept(k);
		if (k < 0) 
			k += m1; 	// approx: 13: MOVE_I R20, T19	// approx: 12: ADD_I T19, R18, IConst: 2147483647
		...
		if (haveRange) 
			return  left +  dm1 * k * width; 	// approx: 44: GETFIELD_D T37, R0, .width	// approx: 43: MUL_D T36, T34, T35	// approx: 41: GETFIELD_D T34, R0, .dm1	// approx: 46: ADD_D T39, T33, T38	// approx: 45: MUL_D T38, T36, T37	// approx: 40: GETFIELD_D T33, R0, .left
		else
	...
	private void initialize (int seed) {
		...
		j0 = jseed % m2;	// approx: 14: MOVE_I R22, T21	// approx: 13: REM_I T21, R20, IConst: 65536
		...
		for (iloop = 0; iloop < 17; ++iloop) 
		{
			...
			j1 = (jseed / m2 + j0 * k1 + j1 * k0) % (m2 / 2);	// approx: 28: ADD_I T35, T33, T34	// approx: 27: MUL_I T34, R27, R6	// approx: 26: ADD_I T33, T31, T32	// approx: 25: MUL_I T32, R28, R7	// approx: 24: DIV_I T31, R30, IConst: 65536	// approx: 30: MOVE_I R37, T36	// approx: 29: REM_I T36, T35, IConst: 32768
			j0 = jseed % m2;	// approx: 32: MOVE_I R39, T38	// approx: 31: REM_I T38, R30, IConst: 65536
			m[iloop] = j0 + m2 * j1;	// approx: 36: ASTORE_I T13, T11, R26	// approx: 35: ADD_I T13, R39, T12	// approx: 34: MUL_I T12, IConst: 65536, R37
		}
		i = 4;
		j = 16;
