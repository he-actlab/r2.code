...
//	protected static boolean R2_APPROX_COUNT = false;
...
//		if(R2_APPROX_COUNT) {
//			if(approx) System.out.println("*** R2_APPROX_COUNT: sVD");
//		}
...
//		if(R2_APPROX_COUNT) {
//			if(approx) System.out.println("*** R2_APPROX_COUNT: lVD");
//		}
...
//		if(R2_APPROX_COUNT) {
//			if(approx) System.out.println("*** R2_APPROX_COUNT: lLD");
//		}
...
//		if(R2_APPROX_COUNT) {
//			if(approx) System.out.println("*** R2_APPROX_COUNT: lAD");
//		}
...
//		if(R2_APPROX_COUNT) {
//			if(approx) System.out.println("*** R2_APPROX_COUNT: lFD");
//		}
		try {
...
//		if(R2_APPROX_COUNT) {
//			if(approx) System.out.println("*** R2_APPROX_COUNT: sLD");
//		}
...
//		if(R2_APPROX_COUNT) {
//			if(approx) System.out.println("*** R2_APPROX_COUNT: sAD");
//		}
...
//		if(R2_APPROX_COUNT) {
//			if(approx) System.out.println("*** R2_APPROX_COUNT: sFD");
//		}
...
//		if(R2_APPROX_COUNT) {
//			if(approx) System.out.println("*** R2_APPROX_COUNT: loadLocal (assignopLocal)");
//		}
