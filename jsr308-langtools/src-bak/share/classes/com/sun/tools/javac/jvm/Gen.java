...
public class Gen extends JCTree.Visitor {
    ...
    private static final boolean EXPAX_TEST_GEN = false;
    ...
    protected Gen(Context context) {
        ...
        expaxInfo = new ExpaxASTNodeInfo();
 ...
 *************************************************************************/
    ...
    public void genDef(JCTree tree, Env<GenContext> env) {
    	if(EXPAX_TEST_GEN){
    		System.out.println("*** EXPAX_TEST_GEN: genDef - tree.toString() = " + tree.toString());
    		System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
    		if(code!=null)
    			System.out.println("*** EXPAX_TEST_GEN: genDef - code.bytecodeOffset = " + code.bytecodeOffset);
    	}
 ...
 *************************************************************************/
    ...
    public void visitMethodDef(JCMethodDecl tree) {
    	if(EXPAX_TEST_GEN){
    		System.out.println("*** EXPAX_TEST_GEN: visitMethodDef - tree.toString() = " + tree.toString());
    		System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
    	}
...
//where
        ...
        void genMethod(JCMethodDecl tree, Env<GenContext> env, boolean fatcode) {
            ...
            if(EXPAX_TEST_GEN){
            	System.out.println("*** EXPAX_TEST_GEN: method name = " + meth.toString());
            	System.out.println("*** EXPAX_TEST_GEN: return type = " + meth.getReturnType().toString());
            	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
            }
            //jspark
            curMethName = meth.toString();
    ...
    public void visitVarDef(JCVariableDecl tree) {
      	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitVarDef = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
      	}
        ...
        if (tree.init != null) {
            ...
            if (v.getConstValue() == null || varDebugInfo) {
                ...
                expaxInfo.add(curClassName, curMethName, curRetTypeName, code.bytecodeOffset, tree.pos, tree.getTag().toString());
    ...
    public void visitBlock(JCBlock tree) {
      	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitBlock = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
      	}
    ...
    public void visitDoLoop(JCDoWhileLoop tree) {
      	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitDoLoop = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
      	}
    ...
    public void visitWhileLoop(JCWhileLoop tree) {
      	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitWhileLoop = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
      	}
    ...
    public void visitForLoop(JCForLoop tree) {
      	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitForLoop = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
      	}
        int limit = code.nextreg;
    ...
    public void visitForeachLoop(JCEnhancedForLoop tree) {
      	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitForeachLoop = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
      	}
    ...
    public void visitLabelled(JCLabeledStatement tree) {
      	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitLabelled = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
      	}
        Env<GenContext> localEnv = env.dup(tree, new GenContext());
    ...
    public void visitSwitch(JCSwitch tree) {
      	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitSwitch = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
      	}
        int limit = code.nextreg;
...
//where
    ...
    public void visitIf(JCIf tree) {
      	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitIf = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
      	}
        int limit = code.nextreg;
        Chain thenExit = null;
    ...
    public void visitExec(JCExpressionStatement tree) {
    	if(EXPAX_TEST_GEN){
    		System.out.println("*** EXPAX_TEST_GEN: visitExec - tree.toString() = " + tree.toString());
    		System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
    	}
    ...
    public void visitBreak(JCBreak tree) {
      	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitBreak = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
      	}
    ...
    public void visitContinue(JCContinue tree) {
      	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitContinue = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
      	}
        Env<GenContext> targetEnv = unwind(tree.target, env);
        Assert.check(code.state.stacksize == 0);
    ...
    public void visitReturn(JCReturn tree) {
      	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitReturn = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
      	}
        int limit = code.nextreg;
    ...
    public void visitThrow(JCThrow tree) {
      	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitThrow = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
      	}
 ...
 *************************************************************************/
    ...
    public void visitApply(JCMethodInvocation tree) {
      	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitApply = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
      	}
    ...
    public void visitConditional(JCConditional tree) {
      	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitConditional = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
      	}
        Chain thenExit = null;
   ...
   private void setTypeAnnotationPositions(int treePos) {
    ...
    public void visitNewClass(JCNewClass tree) {
    	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitNewClass = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
    	}
    ...
    public void visitNewArray(JCNewArray tree) {
    	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitNewArray = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
    	}
        setTypeAnnotationPositions(tree.pos);
...
//where
    ...
    public void visitParens(JCParens tree) {
    	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitParens = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
    	}
    ...
    public void visitAssign(JCAssign tree) {
    	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitAssign = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: visitAssign (bytecode offset) = " + code.bytecodeOffset);
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
    	}
    ...
    public void visitAssignop(JCAssignOp tree) {
    	if(EXPAX_TEST_GEN){
    		System.out.println("*** EXPAX_TEST_GEN: visitAssignop = " + tree.toString());
    		System.out.println("*** EXPAX_TEST_GEN: visitAssignop (bytecode offset) = " + code.bytecodeOffset);
    		System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
    	}
        ...
        if (operator.opcode == string_add) {
            ...
            completeBinop(tree, tree.lhs, tree.rhs, operator).coerce(tree.lhs.type);
        }
        result = items.makeAssignItem(l);
    }
    ...
    public void visitUnary(JCUnary tree) {
    	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitUnary = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
    	}
    	expaxInfo.add(curClassName, curMethName, curRetTypeName, code.bytecodeOffset, tree.pos, tree.getTag().toString());
        OperatorSymbol operator = (OperatorSymbol)tree.operator;
    ...
    private void genNullCheck(DiagnosticPosition pos) {
    	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: genNullCheck");
    	}
    ...
    public void visitBinary(JCBinary tree) {
    	if(EXPAX_TEST_GEN){
	    	System.out.println("*** EXPAX_TEST_GEN: visitBinary = " + tree.toString());
	    	System.out.println("*** EXPAX_TEST_GEN: visitBinary (bytecode offset) = " + code.bytecodeOffset);
	    	System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
    	}
        OperatorSymbol operator = (OperatorSymbol)tree.operator;
        if (operator.opcode == string_add) {
            ...
            od.load();
            result = completeBinop(tree, tree.lhs, tree.rhs, operator);
        }
    }
//where
         ...
         */
        Item completeBinop(JCTree tree, JCTree lhs, JCTree rhs, OperatorSymbol operator) {
    ...
    public void visitIndexed(JCArrayAccess tree) {
    	if(EXPAX_TEST_GEN) {
    		System.out.println("*** EXPAX_TEST_GEN: visitIndexed - tree.toString() = " + tree.toString());
    		System.out.println("*** EXPAX_TEST_GEN: visitIndexed (bytecode offset) = " + code.bytecodeOffset);
    		System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
    	}
    ...
    public void visitIdent(JCIdent tree) {
    	if(EXPAX_TEST_GEN){
    		System.out.println("*** EXPAX_TEST_GEN: visitIdent - tree.toString() = " + tree.toString());
    		System.out.println("*** EXPAX_TEST_GEN: visitIdent (bytecode offset) = " + code.bytecodeOffset);
    		System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
    	}
    	//TODO maybe expaxInfo.add is needed?
//    	expaxInfo.add(curClassName, curMethName, curRetTypeName, code.bytecodeOffset, tree.pos, tree.getTag().toString());
        Symbol sym = tree.sym;
    ...
    public void visitSelect(JCFieldAccess tree) {
    	if(EXPAX_TEST_GEN){
    		System.out.println("*** EXPAX_TEST_GEN: visitSelect - tree.toString() = " + tree.toString());
    		System.out.println("*** EXPAX_TEST_GEN: visitSelect (bytecode offset) = " + code.bytecodeOffset);
    		System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
    	}
    ...
    public void visitLiteral(JCLiteral tree) {
    	if(EXPAX_TEST_GEN){
    		System.out.println("*** EXPAX_TEST_GEN: visitLiteral - tree.toString() = " + tree.toString());
    		System.out.println("*** EXPAX_TEST_GEN: visitLiteral (bytecode offset) = " + code.bytecodeOffset);
    		System.out.println("*** EXPAX_TEST_GEN: tree.getTag() = " + tree.getTag().toString());
    	}
//    	expaxInfo.add(curClassName, curMethName, curRetTypeName, code.bytecodeOffset, tree.pos, tree.getTag().toString());
 ...
 *************************************************************************/
    ...
    public boolean genClass(Env<AttrContext> env, JCClassDecl cdef) {
    	if(EXPAX_TEST_GEN)
    		System.out.println("*** EXPAX_TEST_GEN: class = " + cdef.sym.toString());
        try {
        	//jspark
