...
my $expax_dir = &getenv("EXPAX_ANALYSIS");
my $expax_bench_dir = &getenv("EXPAX_BENCH_USER");
#jspark
...
my @global_options = (
    "-Dchord.ext.java.analysis.path=$expax_dir/classes/",
    "-Dchord.ext.dlog.analysis.path=$expax_dir/src/",
...
$bench_dir = "$expax_bench_dir/$benchmarks{$chosen_program}";
