...
#                 print "UniqueBitvector: " + bitvector
    ...
    # Try to remove stochastic filtering part
    bitvector = ''
    for i in range(bit_size):
        bitvector += str(random.randrange(0, 2))
    LBestGene[name] = [bitvector, zeroBitNum(bitvector), 0, 0, 0]
    MBestGene[name] = [bitvector, zeroBitNum(bitvector), 0, 0, 0]
    FBestGene[name] = [bitvector, zeroBitNum(bitvector), 0, 0, 0]
    HBestGene[name] = [bitvector, zeroBitNum(bitvector), 0, 0, 0]
